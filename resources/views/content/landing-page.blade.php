            ...
            <div id="landingHero" class="section-py landing-hero position-relative">
                ...
                <div class="container">
                    <div class="hero-text-box text-center position-relative">
                        <h1 class="text-primary hero-title display-6 fw-extrabold">Student housing property management software</h1>
                        <h2 class="hero-sub-title h6 mb-6">
                            Optimize your operations, drive revenue, and build lasting relationships with your residents by managing your student housing and multifamily units on one powerful platform.
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            ...
                            <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg">Go To Panel</a>
                        </div>
                    </div>
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                ...
                <h4 class="text-center mb-1">
                    <span class="position-relative fw-extrabold z-1">The advantage 
                ...
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('assets/img/landing-page/Smart_Software.png') }}" alt="laptop charging" />
                        </div>
                        <h5 class="mb-2">Easy to use</h5>
                        <p class="features-icon-description">Intuitive design meets everyday practicality with a clear, consistent user experience that your team can easily learn and navigate.                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('assets/img/landing-page/Mobile.png') }}" alt="edit" />
                        </div>
                        <h5 class="mb-2">Fully mobile</h5>
                        <p class="features-icon-description">Accessible from anywhere on any device, you can keep communication lines open and teams connected while improving efficiency across worksites.</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('assets/img/landing-page/AI.png') }}" alt="3d select solid" />
                        </div>
                        <h5 class="mb-2">Intelligently automated</h5>
                        <p class="features-icon-description">Smart automation and advanced AI help you work faster and free your team to focus on higher-value work.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row gy-6">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-primary shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('assets/img/front-pages/icons/laptop.svg') }}" alt="laptop"
                                    class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-success shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('assets/img/front-pages/icons/user-success.svg') }}" alt="laptop"
                                    class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-info shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('assets/img/front-pages/icons/diamond-info.svg') }}" alt="laptop"
                                    class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('assets/img/front-pages/icons/check-warning.svg') }}" alt="laptop"
                                    class="mb-4" />
