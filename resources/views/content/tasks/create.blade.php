...
<!-- Page Script -->
@section('page-script')
@vite(['resources/js/pages/tasks-create.js'])
@endsection
...
<div id="wizard-property-listing" class="bs-stepper vertical mt-2">
  ...
  <div class="bs-stepper-content">
    <form id="wizard-property-listing-form" onSubmit="return false" method="POST" action="{{ route('tasks.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-6 min-height-300">
          <div class="col-sm-12" >
            <div class="mt-10 mb-4 row">
              ...
              <div class="col-md-10">
                <input class="form-control" type="text" value="" id="task_name" name="task_name" />
              </div>
            </div>
          </div>
        ...
        <div class="row g-6 min-height-300">
          ...
          <div class="col-sm-12">
            ...
            <select id="declarant_id" name="declarant_id" class="select2 form-select form-select-lg" data-allow-clear="true">
              <option value="0" selected>+ Add New Declarant</option>
              @foreach($declarants as $declarant)
                <option value="{{ $declarant->id }}"
          ...
          <div class="col-sm-12 mt-2">
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" id="birthday" name="birthday" class="form-control flatpickr" value=""  />
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="birth_city">{{__('frontend.birth_city')}}</label>
                <input type="text" id="birth_city" name="birth_city" class="form-control" value="" />
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="birth_country">{{__('frontend.birth_country')}}</label>
                <input type="text" id="birth_country" name="birth_country" class="form-control" value="" />
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="home_address">{{__('frontend.address')}}</label>
                <input type="text" id="home_address" name="address" class="form-control" value="" />
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="pec_email">{{__('frontend.pec_email')}}</label>
                <input type="text" id="pec_email" name="address" class="form-control" value="" />
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-sm-12 mt-10">
                <div class="d-flex justify-content-center form-check">
                    <input type="hidden" id="owner_save" name="owner_save" value="0"/>
      ...
      <div id="start-end-dates" class="content">
        <div class="row g-6 min-height-300">
          <div class="col-md-6 col-12 mb-6">
            ...
            <input type="text" id="start_date" name="start_date" class="form-control flatpickr" value=""  />
          </div>
          <div class="col-md-6 col-12 mb-6">
            <label for="dateRangePicker" class="form-label">{{__('frontend.check_out_date')}}</label>
            <input type="text" id="end_date" name="end_date" class="form-control flatpickr" value=""  />
          </div>
          <div class="col-12 d-flex justify-content-between margin-top-auto">
            <button class="btn btn-label-secondary btn-prev"> <i class="bx bx-left-arrow-alt bx-sm me-sm-2 me-0"></i> <span class="align-middle d-sm-inline-block d-none">{{__('frontend.previous')}}</span> </button>
            <button class="btn btn-primary btn-next"> <span class="align-middle d-sm-inline-block d-none me-sm-2">{{__('frontend.next')}}</span> <i class="bx bx-right-arrow-alt bx-sm"></i></button>
      ...
      <div id="rental-property-address" class="content">
        <div class="row g-6 min-height-300 mb-6">
          ...
          <div class="col-sm-12">
            ...
            <select id="property_id" name="property_id" class="select2 form-select form-select-lg" data-allow-clear="true">
              <option value="">{{__('frontend.select_rental_property')}}</option>
              <option value="new" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddProperty">+ Add New Property</option>
          ...
          <div class="col-sm-12 mt-2">
            <div class="row d-none mb-2" id="rental_property_panel">
              <div class="col-sm-12">
                <label class="form-label" for="rental_commune">{{__('frontend.rental_commune')}}</label>
                <input type="text" id="rental_commune" name="rental_commune" class="form-control" placeholder="" />
              </div>
              <div class="col-sm-12">
                <label class="form-label" for="rental_address">{{__('frontend.rental_address')}} </label>
                <input type="text" id="rental_address" name="rental_address" class="form-control" placeholder="" />
              </div>
              <div class="col-sm-4">
                <label class="form-label" for="street_num">{{__('frontend.street_num')}}</label>
                <input type="text" id="street_num" name="street_num" class="form-control" placeholder="" />
              </div>
              <div class="col-sm-4">
                <label class="form-label" for="int_num">{{__('frontend.int_num')}}</label>
                <input type="text" id="int_num" name="int_num" class="form-control" placeholder="" />
              </div>
              <div class="col-sm-4">
          ...
          <div class="col-12 d-flex justify-content-between margin-top-auto">
            <button class="btn btn-label-secondary btn-prev"> <i class="bx bx-left-arrow-alt bx-sm me-sm-2 me-0"></i> <span class="align-middle d-sm-inline-block d-none">{{__('frontend.previous')}}</span> </button>
            <button class="btn btn-primary btn-next disabled" id="rental_property_next_btn"> <span class="align-middle d-sm-inline-block d-none me-sm-2">{{__('frontend.next')}}</span> <i class="bx bx-right-arrow-alt bx-sm"></i></button>
          </div>
        </div>
      </div>
      ...
      <div id="guest-info" class="content">
        <div class="row g-6 min-height-300">
          <div class="col-md-12 mb-2">
            ...
            <input id="guest_email" name="guest_email" class="form-control">
          </div>
          <div class="col-12 d-flex justify-content-between margin-top-auto">
            <button class="btn btn-label-secondary btn-prev"> <i class="bx bx-left-arrow-alt bx-sm me-sm-2 me-0"></i> <span class="align-middle d-sm-inline-block d-none">{{__('frontend.previous')}}</span> </button>
            <button type="submit" class="btn btn-success btn-submit btn-next">{{__('frontend.submit')}}</button>
          </div>
        </div>
      </div>
    </form>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddProperty" aria-labelledby="offcanvasAddPropertyLabel">
  ...
  <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
    <form class="add-new-user pt-0" id="addNewPropertyForm">
      ...
      <div class="mb-6">
        <label class="form-label" for="rental_address">{{ __('frontend.rental_address') }}</label>
        <input type="text" class="form-control" id="add-rental_address" placeholder="" name="rental_address" aria-label="" />
      </div>
      <div class="mb-6">
      ...
      <div class="form-check form-switch mb-6 d-none">
