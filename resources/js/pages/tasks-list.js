...
$(function () {
  ...
  if (dt_task_table.length) {
    var dt_user = dt_task_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a class="btn btn-sm btn-icon view-record" href="' +
              baseUrl +
              `task/${full['id']}` +
              ...
              // // '<a href="javascript:;" class="dropdown-item">Send</a>' +
              // // '<a href="javascript:;" class="dropdown-item">Cancel</a>' +
              // '</div>' +
              '</div>'
            );
          }
      ...
      buttons: [
        ...
        {
          text: '<i class="bx bx-plus bx-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add New Task</span>',
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    window.location.href = `${baseUrl}task\/${user_id}\/edit`;
  });
